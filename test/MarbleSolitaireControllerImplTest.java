...
/**
 * Public test class to test the functionality of the MarbleSolitaireController class.
 */
public class MarbleSolitaireControllerImplTest {
  ...
  public void testQuitAfterThreeInvalidMoves() {
    ...
    MarbleSolitaireController controller = new MarbleSolitaireControllerImpl(model, view, in);
    controller.playGame();
    assertEquals("Invalid MoveInvalid MoveInvalid Move\n" +
            "Game quit!\n" +
            "State of game when quit:\n" +
            "    O O O\n" +
            "    O O O\n" +
  ...
  public void testPlayWholeGame() {
    MarbleSolitaireModel model = new EnglishSolitaireModel();
    Readable in = new StringReader("4 2 4 4 4 5 4 3 4 7 4 5 6 4 4 4 4 4 4 6 5 2 5 4 5 5 5 3 5 " +
            "7 " +
            "5 5 2 4 4 4 2 5 4 5 4 4 4 2 4 5 4 7 4 1 4 3 3 7 3 5 3 2 3 4 3 4 3 6 1 3 3 3 4 3 2 3 " +
            "1 " +
            "5 1 3 1 3 3 3 6 3 4 3 3 3 5 3 6 5 4 5");
    Appendable out = new StringBuilder();
    MarbleSolitaireView view = new MarbleSolitaireTextView(model, out);
    MarbleSolitaireController controller = new MarbleSolitaireControllerImpl(model, view, in);
    controller.playGame();
  ...
  public void testFailAppendable1() {
    ...
    CrashAppendable out = new CrashAppendable();
    MarbleSolitaireModel model = new EnglishSolitaireModel();
    MarbleSolitaireView view = new MarbleSolitaireTextView(model, out);
   ...
   */
  public static class CrashAppendable implements Appendable {
  ...
  public void testFailAppendable2() {
    Readable in = new StringReader("");
    CrashAppendable out = new CrashAppendable();
    MarbleSolitaireModel model = new EnglishSolitaireModel(9, 11, 11);
    MarbleSolitaireView view = new MarbleSolitaireTextView(model, out);
    MarbleSolitaireController testController = new MarbleSolitaireControllerImpl(model, view, in);
